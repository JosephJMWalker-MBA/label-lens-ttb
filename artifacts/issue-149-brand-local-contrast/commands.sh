...
# Fixed preregistered treatment (primary and repeat are both run by this command)
...
DATABASE_URL=sqlite:/private/tmp/label-lens-issue149-local-contrast-e2e.sqlite \
