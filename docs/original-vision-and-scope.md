# Original Vision and Scope (preserved background)

> **Status: background / historical.** This document preserves the project's
> original, largely aspirational README verbatim — the discovery framing,
> stakeholder analysis, full-system architecture ambition, planned label
> fields, batch/coach direction, and performance budgets. It is kept for
> context and reasoning; **it is not a statement of what is implemented today.**
>
> For an accurate description of the **current** system on `main` — what is
> implemented, what is deliberately not, how to run it, and how to evaluate it —
> see the [README](../README.md). Where this document and the README disagree,
> the README is authoritative for current behavior.
